...
R_object HotPyUnicode_DecodeFSDefaultAndSize(const char* s, Py_ssize_t  size);
R_object HotPyUnicode_DecodeFSDefault(const char* s);
...
R_object HotPyUnicode_DecodeUTF7(const char* s, Py_ssize_t  size, const char* errors);
R_object HotPyUnicode_DecodeUTF7Stateful(const char* s, Py_ssize_t  size, const char* errors, Py_ssize_t* consumed);
